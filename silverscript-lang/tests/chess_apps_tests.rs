...
fn size_snapshots() -> Vec<SizeSnapshot> {
    vec![
        SizeSnapshot {
            ...
            expected_bytecode_len: 485,
            expected_sigscript_len: 3701,
            expected_instruction_count: 286,
            expected_charged_op_count: 206,
        },
        SizeSnapshot {
            name: "player.sil",
            ctor: player_constructor_args,
            expected_bytecode_len: 3361,
            expected_sigscript_len: 8449,
            expected_instruction_count: 2452,
            expected_charged_op_count: 1588,
        },
        SizeSnapshot {
            name: "chess_mux.sil",
            ctor: mux_constructor_args,
            expected_bytecode_len: 1752,
            expected_sigscript_len: 3215,
            expected_instruction_count: 1070,
            expected_charged_op_count: 723,
        },
        SizeSnapshot {
            name: "chess_settle.sil",
            ctor: settle_constructor_args,
            expected_bytecode_len: 2720,
            expected_sigscript_len: 10113,
        ...
        SizeSnapshot {
            ...
            expected_bytecode_len: 1857,
            expected_sigscript_len: 3076,
            expected_instruction_count: 1215,
            expected_charged_op_count: 804,
        },
        SizeSnapshot {
            name: "chess_knight.sil",
            ctor: pawn_constructor_args,
            expected_bytecode_len: 1447,
            expected_sigscript_len: 2666,
            expected_instruction_count: 840,
            expected_charged_op_count: 560,
        },
        SizeSnapshot {
            name: "chess_vert.sil",
            ctor: pawn_constructor_args,
            expected_bytecode_len: 2035,
            expected_sigscript_len: 3254,
            expected_instruction_count: 1398,
            expected_charged_op_count: 967,
        },
        SizeSnapshot {
        ...
        SizeSnapshot {
            name: "chess_diag.sil",
            ctor: pawn_constructor_args,
            expected_bytecode_len: 2002,
            expected_sigscript_len: 3221,
            expected_instruction_count: 1372,
            expected_charged_op_count: 949,
        },
        SizeSnapshot {
            name: "chess_king.sil",
            ctor: pawn_constructor_args,
            expected_bytecode_len: 1517,
            expected_sigscript_len: 2736,
        ...
        SizeSnapshot {
            ...
            ctor: pawn_constructor_args,
            expected_bytecode_len: 1563,
            expected_sigscript_len: 2782,
            expected_instruction_count: 950,
            expected_charged_op_count: 627,
        },
        SizeSnapshot {
            name: "chess_castle_challenge.sil",
            ctor: pawn_constructor_args,
            expected_bytecode_len: 1657,
            expected_sigscript_len: 2981,
            expected_instruction_count: 1045,
            expected_charged_op_count: 687,
        },
    ]
}
