...
fn size_snapshots() -> Vec<SizeSnapshot> {
    vec![
        ...
        SizeSnapshot {
            ...
            expected_script_len: 2915,
            expected_instruction_count: 2139,
            expected_charged_op_count: 1489,
        },
        SizeSnapshot {
            name: "chess_mux.sil",
        ...
        SizeSnapshot {
            ...
            expected_script_len: 2654,
            expected_instruction_count: 2046,
            expected_charged_op_count: 1335,
        },
        SizeSnapshot {
            name: "chess_pawn.sil",
        ...
        SizeSnapshot {
            name: "chess_vert.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 2036,
            expected_instruction_count: 1392,
            expected_charged_op_count: 913,
        },
        SizeSnapshot {
        ...
        SizeSnapshot {
            name: "chess_diag.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1815,
            expected_instruction_count: 1209,
            expected_charged_op_count: 791,
        },
        SizeSnapshot {
            name: "chess_king.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1513,
        ...
        SizeSnapshot {
            ...
            ctor: pawn_constructor_args,
            expected_script_len: 1736,
            expected_instruction_count: 1123,
            expected_charged_op_count: 731,
        },
    ]
}
