...
fn size_snapshots() -> Vec<SizeSnapshot> {
    vec![
        SizeSnapshot {
            ...
            expected_script_len: 466,
            expected_instruction_count: 273,
            expected_charged_op_count: 202,
        },
        SizeSnapshot {
            name: "player.sil",
        ...
        SizeSnapshot {
            ...
            expected_script_len: 1650,
            expected_instruction_count: 999,
            expected_charged_op_count: 674,
        },
        SizeSnapshot {
        ...
        SizeSnapshot {
            ...
            expected_script_len: 1855,
            expected_instruction_count: 1231,
            expected_charged_op_count: 803,
        },
        SizeSnapshot {
            name: "chess_knight.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1402,
            expected_instruction_count: 811,
            expected_charged_op_count: 537,
        },
        SizeSnapshot {
            name: "chess_vert.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1877,
            expected_instruction_count: 1251,
            expected_charged_op_count: 825,
        },
        SizeSnapshot {
            name: "chess_horiz.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1870,
            expected_instruction_count: 1244,
            expected_charged_op_count: 825,
        },
        SizeSnapshot {
            name: "chess_diag.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1801,
            expected_instruction_count: 1188,
            expected_charged_op_count: 775,
        },
        SizeSnapshot {
            name: "chess_king.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1477,
            expected_instruction_count: 874,
            expected_charged_op_count: 577,
        },
        SizeSnapshot {
            name: "chess_castle.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1554,
            expected_instruction_count: 949,
            expected_charged_op_count: 619,
        },
        SizeSnapshot {
            name: "chess_castle_challenge.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1725,
            expected_instruction_count: 1113,
            expected_charged_op_count: 721,
        },
    ]
}
