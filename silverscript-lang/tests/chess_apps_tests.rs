...
fn size_snapshots() -> Vec<SizeSnapshot> {
    vec![
        ...
        SizeSnapshot {
            ...
            expected_script_len: 2864,
            expected_instruction_count: 2105,
            expected_charged_op_count: 1468,
        },
        SizeSnapshot {
            name: "chess_mux.sil",
        ...
        SizeSnapshot {
            ...
            expected_script_len: 2803,
            expected_instruction_count: 2118,
            expected_charged_op_count: 1387,
        },
        SizeSnapshot {
            name: "chess_pawn.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1834,
            expected_instruction_count: 1207,
            expected_charged_op_count: 788,
        },
        SizeSnapshot {
            name: "chess_knight.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1384,
            expected_instruction_count: 793,
            expected_charged_op_count: 525,
        },
        SizeSnapshot {
            name: "chess_vert.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1814,
            expected_instruction_count: 1193,
            expected_charged_op_count: 782,
        },
        SizeSnapshot {
        ...
        SizeSnapshot {
            name: "chess_diag.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1774,
            expected_instruction_count: 1161,
            expected_charged_op_count: 757,
        },
        SizeSnapshot {
            name: "chess_king.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1444,
            expected_instruction_count: 847,
            expected_charged_op_count: 559,
        },
        SizeSnapshot {
            name: "chess_castle.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1522,
            expected_instruction_count: 925,
            expected_charged_op_count: 604,
        },
        SizeSnapshot {
            name: "chess_castle_challenge.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1686,
            expected_instruction_count: 1074,
            expected_charged_op_count: 697,
        },
    ]
}
