...
fn size_snapshots() -> Vec<SizeSnapshot> {
    vec![
        SizeSnapshot {
            ...
            expected_bytecode_len: 590,
            expected_sigscript_len: 3862,
        ...
        SizeSnapshot {
            ...
            expected_bytecode_len: 3417,
            expected_sigscript_len: 8717,
            expected_instruction_count: 2466,
            expected_charged_op_count: 1640,
        },
        SizeSnapshot {
            name: "chess_mux.sil",
            ctor: mux_constructor_args,
            expected_bytecode_len: 1908,
            expected_sigscript_len: 3455,
            expected_instruction_count: 1202,
            expected_charged_op_count: 814,
        },
        SizeSnapshot {
            name: "chess_settle.sil",
            ctor: settle_constructor_args,
            expected_bytecode_len: 2816,
            expected_sigscript_len: 10321,
