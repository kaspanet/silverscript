...
fn size_snapshots() -> Vec<SizeSnapshot> {
    vec![
        SizeSnapshot {
            ...
            expected_script_len: 484,
            expected_instruction_count: 285,
            expected_charged_op_count: 211,
        },
        SizeSnapshot {
            name: "player.sil",
            ctor: player_constructor_args,
            expected_script_len: 3378,
            expected_instruction_count: 2472,
            expected_charged_op_count: 1621,
        },
        SizeSnapshot {
            name: "chess_mux.sil",
            ctor: mux_constructor_args,
            expected_script_len: 1700,
            expected_instruction_count: 1032,
            expected_charged_op_count: 709,
        },
        SizeSnapshot {
            name: "chess_settle.sil",
            ctor: settle_constructor_args,
            expected_script_len: 2546,
            expected_instruction_count: 1958,
            expected_charged_op_count: 1292,
        },
        SizeSnapshot {
            name: "chess_pawn.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1848,
            expected_instruction_count: 1208,
            expected_charged_op_count: 810,
        },
        SizeSnapshot {
            name: "chess_knight.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1434,
            expected_instruction_count: 829,
            expected_charged_op_count: 563,
        },
        SizeSnapshot {
            name: "chess_vert.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 2022,
            expected_instruction_count: 1387,
        ...
        SizeSnapshot {
            name: "chess_diag.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1989,
            expected_instruction_count: 1361,
            expected_charged_op_count: 952,
        },
        SizeSnapshot {
            name: "chess_king.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1504,
            expected_instruction_count: 880,
            expected_charged_op_count: 598,
        },
        SizeSnapshot {
            name: "chess_castle.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1550,
            expected_instruction_count: 939,
            expected_charged_op_count: 630,
        },
        SizeSnapshot {
            name: "chess_castle_challenge.sil",
            ctor: pawn_constructor_args,
            expected_script_len: 1643,
            expected_instruction_count: 1034,
            expected_charged_op_count: 690,
        },
    ]
}
