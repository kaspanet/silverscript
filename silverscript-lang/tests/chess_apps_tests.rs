...
fn size_snapshots() -> Vec<SizeSnapshot> {
    vec![
        SizeSnapshot {
            ...
            expected_bytecode_len: 548,
            expected_sigscript_len: 3701,
            expected_instruction_count: 342,
            expected_charged_op_count: 246,
        },
        SizeSnapshot {
            name: "player.sil",
            ctor: player_constructor_args,
            expected_bytecode_len: 3294,
            expected_sigscript_len: 8383,
            expected_instruction_count: 2355,
            expected_charged_op_count: 1563,
        },
        SizeSnapshot {
            name: "chess_mux.sil",
            ctor: mux_constructor_args,
            expected_bytecode_len: 1820,
            expected_sigscript_len: 3367,
            expected_instruction_count: 1129,
            expected_charged_op_count: 763,
        },
        SizeSnapshot {
            name: "chess_settle.sil",
            ctor: settle_constructor_args,
            expected_bytecode_len: 2802,
            expected_sigscript_len: 10061,
            expected_instruction_count: 2107,
            expected_charged_op_count: 1375,
        },
        SizeSnapshot {
            name: "chess_pawn.sil",
            ctor: pawn_constructor_args,
            expected_bytecode_len: 1941,
            expected_sigscript_len: 3228,
            expected_instruction_count: 1291,
            expected_charged_op_count: 860,
        },
        SizeSnapshot {
            name: "chess_knight.sil",
            ctor: pawn_constructor_args,
            expected_bytecode_len: 1577,
            expected_sigscript_len: 2864,
            expected_instruction_count: 942,
            expected_charged_op_count: 628,
        },
        SizeSnapshot {
            name: "chess_vert.sil",
            ctor: pawn_constructor_args,
            expected_bytecode_len: 2106,
            expected_sigscript_len: 3393,
            expected_instruction_count: 1458,
            expected_charged_op_count: 1007,
        },
        SizeSnapshot {
            name: "chess_horiz.sil",
            ctor: pawn_constructor_args,
            expected_bytecode_len: 2105,
            expected_sigscript_len: 3392,
            expected_instruction_count: 1457,
            expected_charged_op_count: 1007,
        },
        SizeSnapshot {
            name: "chess_diag.sil",
            ctor: pawn_constructor_args,
            expected_bytecode_len: 2072,
            expected_sigscript_len: 3359,
            expected_instruction_count: 1437,
            expected_charged_op_count: 991,
        },
        SizeSnapshot {
            name: "chess_king.sil",
            ctor: pawn_constructor_args,
            expected_bytecode_len: 1601,
            expected_sigscript_len: 2888,
            expected_instruction_count: 971,
            expected_charged_op_count: 651,
        },
        SizeSnapshot {
            name: "chess_castle.sil",
            ctor: pawn_constructor_args,
            expected_bytecode_len: 1638,
            expected_sigscript_len: 2925,
            expected_instruction_count: 1017,
            expected_charged_op_count: 669,
        },
        SizeSnapshot {
            name: "chess_castle_challenge.sil",
            ctor: pawn_constructor_args,
            expected_bytecode_len: 1732,
            expected_sigscript_len: 3140,
            expected_instruction_count: 1122,
            expected_charged_op_count: 739,
        },
    ]
}
