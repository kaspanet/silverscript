...
fn size_snapshots() -> Vec<SizeSnapshot> {
    vec![
        ...
        SizeSnapshot {
            ...
            expected_bytecode_len: 1921,
            expected_sigscript_len: 3473,
        ...
        SizeSnapshot {
            ...
            expected_bytecode_len: 1954,
            expected_sigscript_len: 3334,
        ...
        SizeSnapshot {
            ...
            ctor: pawn_constructor_args,
            expected_bytecode_len: 1590,
            expected_sigscript_len: 2970,
        ...
        SizeSnapshot {
            ...
            ctor: pawn_constructor_args,
            expected_bytecode_len: 2118,
            expected_sigscript_len: 3498,
        ...
        SizeSnapshot {
            name: "chess_diag.sil",
            ctor: pawn_constructor_args,
            expected_bytecode_len: 2085,
            expected_sigscript_len: 3465,
        ...
        SizeSnapshot {
            name: "chess_king.sil",
            ctor: pawn_constructor_args,
            expected_bytecode_len: 1614,
            expected_sigscript_len: 2994,
        ...
        SizeSnapshot {
            ...
            ctor: pawn_constructor_args,
            expected_bytecode_len: 1651,
            expected_sigscript_len: 3031,
        ...
        SizeSnapshot {
            ...
            ctor: pawn_constructor_args,
            expected_bytecode_len: 1745,
            expected_sigscript_len: 3158,
