...
export default grammar({
  ...
  rules: {
    ...
    tuple_index: ($) => seq("[", $.number, "]"), // Pest uses NumberLiteral here (no unit)

    unary_suffix: (_) => choice(".reverse()", ".length"),
    ...
    // Identifier excludes keywords in Pest; in Tree-sitter, prefer keywords via token precedence.
